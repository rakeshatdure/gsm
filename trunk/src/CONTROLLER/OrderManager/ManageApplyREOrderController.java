...
/**
 * Servlet implementation class ManageApplyREOrderController
 */
@WebServlet("/ManageApplyREOrderController")
public class ManageApplyREOrderController extends HttpServlet {
	 ...
	 */
	public ManageApplyREOrderController() {
		super();
	...
	public void process(HttpServletRequest request, HttpServletResponse response)
		...
		List<Productorderdetail>[] arrays = ProductorderdetailBUS
				.getListPODetailShippingCompletedByBuyer(user, lang, fromDate,
		...
		request.setAttribute("listordershippingcompleted", arrays[1]);
		request.getRequestDispatcher("/applyreturnexchangeorder.html").forward(
				request, response);
	}
