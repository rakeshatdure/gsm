...
//insert
	public static boolean inserṭ̣̣̣(Confirm confirm,String lang){
	...
	public static Confirm getCurrentCancelConfirm(int referenceID,String object,String lang){
		List<Confirm> list=HibernateDAO.getList("from Confirm where orderCancelID ='"+referenceID+"' and object='"+object+"' and isCurrent ='true'", lang);
		if(list!=null && !list.isEmpty()){
			return list.get(0);
		}
		return null;
